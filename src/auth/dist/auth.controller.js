...
var AuthController = /** @class */ (function () {
    ...
    AuthController.prototype.login = function (loginDTO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.findByLogin(loginDTO)];
                    case 1:
                        user = _a.sent();
                        payload = {
                        ...
                        return [4 /*yield*/, this.authService.signPayload(payload)];
                    case 2:
                        token = _a.sent();
    ...
    AuthController.prototype.register = function (registerDTO) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.create(registerDTO)];
                    case 1:
                        user = _a.sent();
                        payload = {
                            username: user.username,
